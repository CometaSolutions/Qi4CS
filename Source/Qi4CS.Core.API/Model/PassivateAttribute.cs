 ...
 * org.qi4j.api.service.Activatable class)
...
{
   /// <summary>
   /// This special scope attribute is used to mark methods which should be called at service passivation.
   /// Services are passivated when the Qi4CS <see cref="API.Instance.Application"/> is passivated, but only if they were activated.
   ...
   public class PassivateAttribute : Attribute
   {
   }
}
