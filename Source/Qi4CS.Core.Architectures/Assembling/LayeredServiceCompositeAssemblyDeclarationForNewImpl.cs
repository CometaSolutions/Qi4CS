...
{
   internal class LayeredServiceCompositeAssemblyDeclarationForNewImpl : ServiceCompositeAssemblyDeclarationForNewImpl, LayeredServiceCompositeAssemblyDeclaration
   {
