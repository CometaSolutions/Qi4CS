...
{
   internal abstract class LayeredAbstractCompositeAssemblyDeclarationForNewImpl : AbstractCompositeAssemblyDeclarationForNewImpl, LayeredAbstractCompositeAssemblyDeclaration
   {
      internal LayeredAbstractCompositeAssemblyDeclarationForNewImpl( Assembler assembler, DictionaryWithRoles<Type, ListProxy<CompositeAssemblyInfo>, ListProxyQuery<CompositeAssemblyInfo>, ListQuery<CompositeAssemblyInfo>> compositeAssemblyInfos, LayeredCompositeAssemblyInfo assemblyInfo, CollectionsFactory collectionsFactory )
      ...
      {
         ( (LayeredCompositeAssemblyInfo) this.Info ).Visibility = visibility;
         return this;
      }
   ...
   internal class LayeredPlainCompositeAssemblyDeclarationForNewImpl : LayeredAbstractCompositeAssemblyDeclarationForNewImpl, LayeredPlainCompositeAssemblyDeclaration
   {
