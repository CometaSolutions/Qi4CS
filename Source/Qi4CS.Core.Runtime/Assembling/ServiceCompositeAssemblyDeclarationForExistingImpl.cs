...
{
   public class ServiceCompositeAssemblyDeclarationForExistingImpl : AbstractCompositeAssemblyDeclarationForExistingImpl, ServiceCompositeAssemblyDeclaration
   {
      ...
      {
         this.ForEachInfo( info => ( (ServiceCompositeAssemblyInfo) info ).ServiceID = serviceID );
         return this;
      }

      public ServiceCompositeAssemblyDeclaration SetActivateWithApplication( Boolean activateWithApplication )
      {
         this.ForEachInfo( info => ( (ServiceCompositeAssemblyInfo) info ).ActivateWithApplication = activateWithApplication );
         return this;
      }
