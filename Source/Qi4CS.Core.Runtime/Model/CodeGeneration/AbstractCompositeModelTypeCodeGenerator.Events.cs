...
namespace Qi4CS.Core.Runtime.Model
{
   public abstract partial class AbstractCompositeModelTypeCodeGenerator
   {
      ...
      )
      {
         ...
         var eventInfo = this.ctx.NewWrapper( nEventInfo );
         ...
         if ( this.IsCompositeGeneratedEvent( thisGenerationInfo, eventModel, genericEventMixinType ) )
         {
            ...
            var invokeMethodFromModel = this.ctx.NewWrapper( eventModel.NativeInfo.EventHandlerType.GetMethod( DELEGATE_INVOKE_METHOD_NAME ) );
            ...
            var addMethod = this.ImplementMethodForEmitting(
               thisGenerationInfo,
               this.ctx.NewWrapper( eventModel.AddMethod.NativeInfo ),
            ...
            CompositeMethodGenerationInfo removeMethod = this.ImplementMethodForEmitting(
               thisGenerationInfo,
               this.ctx.NewWrapper( eventModel.RemoveMethod.NativeInfo ),
         ...
         )
      {
         ...
         {
            // TODO TODO TODO 
            this.EmitThrowIfExceptionListHasAny( invokeMethod, this.ctx.NewWrapper( exceptionType.GetConstructor( EXCEPTION_ENUMERABLE_ARRAY ) ) );
         }
         ...
         if ( !VOID_TYPE.Equals( eventMethodToInvoke.GetReturnType() ) )
         {
            ...
            il
               ...
               .EmitReflectionObjectOf( TypeGenerationUtils.CreateTypeForEmitting( this.ctx.NewWrapper( eventInfo.DeclaringType ), thisGenerationInfo.GenericArguments, null ) )
