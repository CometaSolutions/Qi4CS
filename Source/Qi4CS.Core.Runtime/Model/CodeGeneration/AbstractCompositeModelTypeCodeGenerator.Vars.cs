...
namespace Qi4CS.Core.Runtime.Model
{
   public partial class AbstractCompositeModelTypeCodeGenerator
   {
      ...
      protected AbstractCompositeModelTypeCodeGenerator( CompositeCodeGenerationInfo codeGenInfo, Boolean isSilverlight, CILReflectionContext aCtx )
      {
         ...
         this.PUBLIC_COMPOSITE_GENERIC_BINDING_ATTRIBUTE_CTOR = PUBLIC_COMPOSITE_GENERIC_BINDING_ATTRIBUTE_CTOR_NATIVE.NewWrapper( ctx );
         this.PUBLIC_COMPOSITE_GENERIC_BINDING_ATTRIBUTE_PROPERTY = PUBLIC_COMPOSITE_GENERIC_BINDING_ATTRIBUTE_PROPERTY_NATIVE.NewWrapper( ctx );
      }
   }
}
#endif