...
{
   public class SideEffectForInjectionFunctionality : InjectionFunctionality
   {
      ...
      public ValidationResult InjectionPossible( SPI.Model.AbstractInjectableModel model )
      {
         ...
         return new ValidationResult(
            ...
            "The side effect type must be either generic or a sub-type of composite type"
            );
      }

      public Object ProvideInjection( CompositeInstance instance, AbstractInjectableModel model, Type targetType )
      {
         return ( (CompositeInstanceImpl) instance ).CreateOrGetSideEffectInvocationBase( targetType );
      }
